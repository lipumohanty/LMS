...
if (isset($_POST["submit"])) {
    ...
    if (empty($strError)) {
        ...
        $inserted = mysql_query("SELECT * FROM `tbl_inward`");
    }
}
?>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 style="float:left;width:50%;" class="page-head-line">Inward Reports</h1>
                                        ...
                                        <table summary="This table shows how to create responsive tables using Bootstrap's default functionality" class="table table-bordered table-hover">
                                            ...
                                            <thead style="border:1px solid black;">
                                                <tr>
                                                    <th id="th11">Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                                    <th id="th11">Time</th>
                                                    <th id="th11">Inward Number</th>
                                                    <th id="th11">Reference No.& Date</th>
                                                    <th id="th11">Subject</th>
                                                    <th id="th11">Whether Address to this office</th>
                                                    <th id="th11"> From</th>
                                                    <th id="th11">File No. Of RO</th>
                                                    <th id="th11">Linked Outward Letter No.</th>
                                                    <th id="th11">Remark</th>
                                                    <th id="th11">File No.</th>
                                                    <th id="th11">Mode of Receipt</th>
                                            ...
                                            <?php
                                            if (isset($_POST["submit"])) {
                                                $sqlin = "SELECT * FROM tbl_inward 
  LEFT JOIN tbl_in_file
ON tbl_inward.in_id=tbl_in_file.infile_id
  
  WHERE fix='" . RO . "' and date BETWEEN '" . $date_from . "' and '" . $date_to . "'";
                                                ...
                                                while ($results = mysql_fetch_assoc($sqlinward)) {
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td id="td11"><?php echo $results['in_id']; ?></td>
                                                            ...
                                                            <td id="td11"><?php echo $results['ro_file_no']; ?></td>
                                                            <td id="td11"><?php echo $results['link_out']; ?></td>
                                                            <td id="td11"><?php echo $results['remark']; ?></td>
                                                            <td id="td11"><?php echo $results['file_no']; ?></td>
                                                ...
                                                if (isset($_POST["submitin"])) {
                                                    ...
                                                    $sqlin1 = "SELECT * FROM tbl_inward 
  LEFT JOIN tbl_in_file
  
ON tbl_inward.in_id=tbl_in_file.in_no
  
  WHERE subject ='" . $searchin . "' or `from` ='" . $searchin . "' ";
