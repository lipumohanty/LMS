...
if (isset($_POST["submit"])) {
    ...
    $sqlSelect = "SELECT * FROM tbl_admin WHERE username='" . $username . "' and password= '" . $password . "' ";
    ...
    if (count($result) != 0) {
        ...
        if ($user_type == 1) {
            header("location:index.php?requestPage=");
        } else {
            header("location:index.php?requestPage=");
        }
    } else {
...
//    $res = mysql_num_rows($sqlSelected);
//    while ($result = mysql_fetch_assoc($sqlSelected)) {
//        $_SESSION['user_type'] = $result['user_type'];
//        $_SESSION['username'] = $result['username'];
//        $_SESSION['name'] = $result['name'];
//        $_SESSION['txtId'] = $result['txtId'];
//    }
//    if ($res > 0) {
...
//        }
//    } else {
//        $error = "<h1>Enter Correct Username & Password</h1>";
//    }
//    MysqlConnection::insert("tbl_admin", $_POST);
}
?>
