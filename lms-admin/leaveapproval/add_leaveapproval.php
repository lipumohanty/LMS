                        ...
                        <table class="table table-bordered data-table" style="font-size: 11px;">
                            ...
                            <tbody>
                                ...
                                foreach ($resource as $result) {
                                    ...
                                    <tr class="gradeX">
                                        <td>
                                            <a title="APPROVE" href="mainpage.php?requestPage=edit_leaveapproval&txtId=<?php echo $result["txtId"] ?>&empId=<?php echo $result["empId"] ?>">
                                                <button type="button" class="btn btn-success">APPROVE</button>
                                            </a>
                                        </td>
                                        <td>
                                            <a title="REJECT" href="mainpage.php?requestPage=reject_leaveapproval&txtId=<?php echo $result["txtId"] ?>&empId=<?php echo $result["empId"] ?>">
